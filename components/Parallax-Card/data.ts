export const projects = [
    {
      title: "Projects",
      description: "URECKATHON,organized by the University of Engineering and Management, Kolkata, proudly announces its 4th edition, dedicated to igniting a fervent passion for technology. Led by esteemed faculty members, we aspire to cultivate boundless innovation in the realm of technology. URECKATHON platform aims to foster teamwork, learning, and innovation by addressing significant challenges through the creation of novel technologies and prototypes.",
      src: "rock.jpg",
